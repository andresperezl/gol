...
// NewGetChampionMasteryScoreParams creates a new GetChampionMasteryScoreParams object
// with the default values initialized.
func NewGetChampionMasteryScoreParams() *GetChampionMasteryScoreParams {
	var ()
	return &GetChampionMasteryScoreParams{

		timeout: cr.DefaultTimeout,
	}
}

// NewGetChampionMasteryScoreParamsWithTimeout creates a new GetChampionMasteryScoreParams object
...
// NewGetChampionMasteryScoreParamsWithContext creates a new GetChampionMasteryScoreParams object
...
// NewGetChampionMasteryScoreParamsWithHTTPClient creates a new GetChampionMasteryScoreParams object
...
/*GetChampionMasteryScoreParams contains all the parameters to send to the API endpoint
for the get champion mastery score operation typically these are written to a http.Request
*/
...
func (o *GetChampionMasteryScoreParams) WithTimeout(timeout time.Duration) *GetChampionMasteryScoreParams {
...
func (o *GetChampionMasteryScoreParams) WithContext(ctx context.Context) *GetChampionMasteryScoreParams {
	o.SetContext(ctx)
	return o
}
...
func (o *GetChampionMasteryScoreParams) WithHTTPClient(client *http.Client) *GetChampionMasteryScoreParams {
...
func (o *GetChampionMasteryScoreParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
